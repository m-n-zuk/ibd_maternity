    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_details', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ibd_website.patient')),
            ],
        ),
        migrations.CreateModel(
            name='Doctor',
            fields=[
                ...
                ('visit_term', models.ManyToManyField(through='ibd_visits.DoctorVisit', to='ibd_visits.visitterm')),
            ],
        ),
    ]
